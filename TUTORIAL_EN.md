...
* Multi-core support. Leaf utilize its modules and [leaf/go](https://github.com/zsai001/leaf_cluster/tree/master/go) to make use of CPU resouces at maximum while avoiding varieties of side effects may be caused.
...
A game server implemented with Leaf may include many modules (e.g. [LeafServer](https://github.com/zsai001/leaf_clusterserver)) which all share below traits:

* Each module runs inside a separate goroutine
* Modules communicate with one another via a light weight RPC channel([leaf/chanrpc](https://github.com/zsai001/leaf_cluster/tree/master/chanrpc))
...
[LeafServer](https://github.com/zsai001/leaf_clusterserver) is a game server developped with Leaf. Let's start with it.

Download the source code of LeafServer：

```
git clone https://github.com/zsai001/leaf_clusterserver
```

Download and install leafserver to GOPATH:

```
go get github.com/zsai001/leaf_cluster
```
...
import (
    "github.com/zsai001/leaf_cluster/network/json"
)
...
import (
    ...
    "github.com/zsai001/leaf_cluster/gate"
    "reflect"
    "server/msg"
)
...
More references are at [leaf/go](https://github.com/zsai001/leaf_cluster/blob/master/go)。
...
More references are at [leaf/timer](https://github.com/zsai001/leaf_cluster/blob/master/timer)。
...
More references are at [leaf/log](https://github.com/zsai001/leaf_cluster/blob/master/log).

### Leaf recordfile

Leaf recordfile is formatted in CSV([Example](https://github.com/zsai001/leaf_cluster/blob/master/recordfile/test.txt)). recordfile is to manage the configuration for game. The usage of recordfile in LeafServer is quite simple:
...
Refer to [leaf/recordfile](https://github.com/zsai001/leaf_cluster/blob/master/recordfile) for more details.

Learn more
----------

More references are at Wiki [https://github.com/zsai001/leaf_cluster/wiki](https://github.com/zsai001/leaf_cluster/wiki)
